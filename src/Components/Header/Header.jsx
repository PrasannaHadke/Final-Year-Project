        ...
        <header className="shadow sticky z-50 top-0">
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    {/* Mobile Menu */}
                    <div 
                        className={`${menuOpen ? 'flex' : 'hidden'} flex-col absolute top-full left-0 w-full bg-white lg:hidden shadow-md`}
                    >
                        <ul className="flex flex-col mt-4 font-medium">
                            <li>
                                <NavLink
                                    to="/"
                                    className={({ isActive }) => `block py-2 pr-4 pl-3 duration-200 border-b border-gray-100 hover:bg-gray-50 hover:text-orange-700 lg:p-0 ${isActive ? "text-orange-700" : "text-gray-800"}`}
